...
train_dataset = load_dataset("hrabalm/mtm24-akkadian-v1", split="train")
...
class MyDataCollator:
    ...
    def __call__(self, examples):
        ...
        batch = processor(text=texts, images=images, return_tensors="pt", padding=True, max_length=4096, truncation=True)
...
training_args = TrainingArguments(
    ...
    weight_decay=0.01,
    logging_steps=1,
    output_dir="./model_visual_splitting_v3",
    save_strategy="steps",
    save_steps=100,
