#!/usr/bin/env python3
# from https://github.com/esalesky/minimal-renderer/
...
os.environ["FONTCONFIG_FILE"] = "/usr/local/etc/fonts/fonts.conf"

fallback_fonts_dir = './fonts/fallback_fonts'
...
class TextImageGenerator():
    ...
    def _render_text_to_surface(self, text:str):
        ...
        # Adding eos patch (disabled for this example)
